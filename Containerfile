FROM registry.access.redhat.com/ubi10/ubi-minimal@sha256:c07753b82a485973c441b2dfefb909ff17486409f49a1800a30e9ea4f104aeb9 AS squid-base
...
# ==========================================
FROM squid-base AS squid-exporter-builder
